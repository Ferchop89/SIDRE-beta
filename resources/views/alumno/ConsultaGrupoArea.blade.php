               ...
               <div class="panel-body">
                  ...
                  <div class="consulta">
                    <p>Selecciona el grupo que deseas consultar:</p>
                     <form class="" id="formulario_consulta" name="form-data" action="{{ route('alumno.reinscripcion-grupo.area', $area) }}" method="POST" accept-charset="UTF-8">
                        {{ csrf_field() }}
                     ...
                     <div class="grado">
                         <div class="row-grado">
                             <a class="btn btn-blue flex-item" href="{{route("alumno.areas_re", 6)}}" role="button">Regresar</a>
                         </div>
                     </div>
                  </div>
               </div>
