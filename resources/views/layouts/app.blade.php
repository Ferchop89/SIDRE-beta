                            ...
                            @else
                                <li class="dropdown">
                                    <a id="btn" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" aria-haspopup="true">
                                       {{-- {{ Auth::user()->num_cta }} <span class="caret"></span> --}}
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="{{ url('alumno/change-password/'.Auth::user()->id) }}"
                                                onclick="event.preventDefault();
                                                         document.getElementById('reset-pass').submit();">
                                                Cambiar Contraseña
                                            </a>

                                            <form id="reset-pass" action="{{ url('alumno/change-password/'.Auth::user()->id) }}" method="GET" style="display: block; color: black;">
                                                {{ csrf_field() }}
                                            </form>
                                        </li>
                                        <li>
