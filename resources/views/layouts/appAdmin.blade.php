                        ...
                        <ul class="nav navbar-nav navbar-left">
                           <li class="dropdown">
                              ...
                              <ul class="dropdown-menu">
                                 <li>
                                    <a href="{{asset(route('buscar.alumno'))}}">Activar/Bloquear</a>
                                 </li>
                              </ul>
                           </li>

                           <li><a id="btn" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" href="">Reportes
                              <span class="caret"></span>
                              </a>
                           </li>
                           <li>
                              <a id="btn" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" href="">
                                 Reinscripciones
                                 <span class="caret"></span>
                              </a>
                              <ul class="dropdown-menu">
                                 <li>
                                    <a href="{{asset(route('carga.alumnos'))}}">Cargar Alumnos</a>
                                 </li>
                                 <li>
                                    <a href="{{asset(route('carga.historias'))}}">Cargar HA</a>
                                 </li>
                                 <li>
                                    <a href="{{asset(route('promedios.historico'))}}">Calcular Promedios</a>
                                 </li>
                                 <li>
                                    <a href="{{asset(route('calcula.turno'))}}">Asignar turnos</a>
                                 </li>
                                 <li>
                                    <a href="{{asset(route('calcula.turno'))}}">Reinscribir recursadores</a>
                                 </li>
                              </ul>
                           </li>
                           <li>
